...
namespace EventStore.ClientAPI.UserManagement
{
    internal class UsersClient
    {
        ...
        {
            return SendPost(endPoint.ToHttpUrl(httpSchema, "/users/{0}/command/enable", login), string.Empty, userCredentials, HttpStatusCode.OK);
        }
        ...
        {
            return SendPost(endPoint.ToHttpUrl(httpSchema, "/users/{0}/command/disable", login), string.Empty, userCredentials, HttpStatusCode.OK);
        }
        ...
        {
            return SendDelete(endPoint.ToHttpUrl(httpSchema, "/users/{0}", login), userCredentials, HttpStatusCode.OK);
        }
