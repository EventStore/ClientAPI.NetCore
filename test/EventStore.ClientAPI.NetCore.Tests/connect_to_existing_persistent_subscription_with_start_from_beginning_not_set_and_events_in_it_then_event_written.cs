...
namespace Eventstore.ClientAPI.Tests
{
    ...
    public class connect_to_existing_persistent_subscription_with_start_from_beginning_not_set_and_events_in_it_then_event_written : SpecificationWithConnection
    {
