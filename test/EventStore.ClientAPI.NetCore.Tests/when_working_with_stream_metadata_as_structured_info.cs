...
namespace EventStore.Core.Tests.ClientAPI
{
    ...
    public class when_working_with_stream_metadata_as_structured_info 
    {
        ...
        {
            Assert.That(() => _connection.SetStreamMetadataAsync(_stream, 2, StreamMetadata.Create()).Result,
        ...
        {
            _connection.AppendToStreamAsync(_stream, ExpectedVersion.EmptyStream, TestEvent.NewTestEvent()).Wait();
        ...
        public void setting_correctly_formatted_metadata_as_raw_allows_to_read_it_as_structured_metadata()
        {
            ...
            _connection.SetStreamMetadataAsync(_stream, ExpectedVersion.EmptyStream, rawMeta).Wait();
